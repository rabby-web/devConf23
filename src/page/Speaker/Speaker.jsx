...
const Speaker = () => {
  return (
    <div className="bg-slate-100 my-10 mx-2 rounded-md">
      <h2 className="text-4xl  pt-10 text-[#387DF8] font-bold text-center sm:text-5xl ">
        Our Event Populer Speker
      </h2>
      <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
        <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
          ...
          >
            ...
            />
            <div>
              <p className="text-2xl font-semibold">Rabbil Hasan Rupom</p>
            </div>
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <h2 className="text-xl font-medium">
                Founder & Educator, Learn with Rabbil Hasan
              </h2>
            </div>
          </div>
          <div
          ...
          >
            ...
            />
            <div>
              <p className="text-2xl font-semibold">Zulkarnine Mahmud</p>
            </div>
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
          ...
          >
            ...
            />
            <div>
              <p className="text-2xl font-semibold">Jhankar Mahbub</p>
            </div>
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <h2 className="text-xl font-medium">Founder, Programming Hero</h2>
            </div>
          </div>
        </div>
      </div>
